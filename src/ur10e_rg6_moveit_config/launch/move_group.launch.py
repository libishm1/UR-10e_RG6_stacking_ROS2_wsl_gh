    ...
    move_group = Node(
        ...
        parameters=[
            ...
            {"publish_robot_description_semantic": True,
             ...
             # bound would cancel every trajectory. Bumping to 30x still wasn't
             # enough for short LIN moves where planned duration is ~2s but
             # actual is 60-100s (30x = 60s timeout, cabinet finishes at 70s).
             # 2026-05-26 — DISABLED execution duration monitoring entirely.
             # The cabinet's URP enforces its own safety timeouts so this is
             # safe. Re-enable + set scaling to 1.2 once we move ros2_control
             # off WSL2. See wiki/known_bugs_and_workarounds.md RTDE entry.
